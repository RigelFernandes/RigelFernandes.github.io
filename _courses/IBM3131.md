...
(2) Sensor Capture: The image sensor (Complementary Metal–Oxide–Semiconductor (CMOS) or Charge-Coupled Devices (CCD)) converts light intensity into electrical signals [1](#ref1). Each sensor element (pixel) records brightness, and in color cameras, a Bayer filter captures RGB values.
...
[<a id="ref1">1</a>] <a href="https://doi.org/10.1016/j.mejo.2005.07.002" target="_blank">Bigas, M., Cabruja, E., Forest, J., & Salvi, J. (2006). Review of CMOS image sensors. Microelectronics journal, 37(5), 433-451.</a>
