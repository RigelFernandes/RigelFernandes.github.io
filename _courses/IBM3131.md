...
(2) Sensor Capture: The image sensor (Complementary Metal–Oxide–Semiconductor (CMOS) or Charge-Coupled Devices (CCD)) converts light intensity into electrical signals [bigas2006review](https://doi.org/10.1016/j.mejo.2005.07.002). Each sensor element (pixel) records brightness, and in color cameras, a Bayer filter captures RGB values.
