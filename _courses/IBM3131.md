...
(2) Sensor Capture: The image sensor (Complementary Metal–Oxide–Semiconductor (CMOS) or Charge-Coupled Devices (CCD)) converts light intensity into electrical signals. Each sensor element (pixel) records brightness, and in color cameras, a Bayer filter captures RGB values.
