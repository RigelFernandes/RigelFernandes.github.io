...
// define entrada analógica A0
#define sensorPin A0

// variável inteiro igual a zero
int sensorValue = 0;
// variável número fracionário
float voltage;
...
Types:
    ...
    Inductive Sensors: Detect metallic objects using electromagnetic fields; used in ind
