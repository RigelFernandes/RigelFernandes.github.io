...
[25] Rigel P. Fernandes, José A. Apolinário Jr., Julio Cesar Duarte, and José M. de Seixas, "Optimized TDOA-based drone localization with distributed microphones," Journal of Communication and Information Systems, vol. 41, no. 1, 32–43, 2026. Available: [https://doi.org/10.14209/jcis.2026.4](https://doi.org/10.14209/jcis.2026.4){:target="_blank"} <button id="copyButton25" onclick="copyToClipboard25()">Copy BibTeX</button>
