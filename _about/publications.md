...
[28] Nicholas Borges de Vasconcelos, Mel Bozzola, Adam Bleiel, Rigel P. Fernandes, Victor A. Azevedo Costa Santos, and Thiago Souza (2026). Ethical aspects of face recognition systems. In 2nd Latin American Ethics on Artificial Inteligence - LAAI-Ethics 2026, September 16TH to 18TH, Niterói, RJ, Brasil. Sociedade Brasileira de Computação. **Accepted for publication** <button id="copyButton28" onclick="copyToClipboard28()">Copy BibTeX</button>

[27] Enzo Tarrade, Mekki Ouhoud, Mel Bozzola, Rigel P. Fernandes, Thiago Souza, and Victor A. Azevedo Costa Santos (2026). Ethical Concerns in AI-Generated Virtual Influencer Marketing: Transparency, Trust, and Consumer Protection. In 2nd Latin American Ethics on Artificial Inteligence - LAAI-Ethics 2026, September 16TH to 18TH, Niterói, RJ, Brasil. Sociedade Brasileira de Computação. **Accepted for publication** <button id="copyButton27" onclick="copyToClipboard27()">Copy BibTeX</button>
